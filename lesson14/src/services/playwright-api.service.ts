...
export class PlaywrightApiService implements IApiService<APIResponse> {
    ...
    public constructor(public readonly baseUrl: string, private secret: { apiKey?: string, basicToken?: string, jwtToken?: string }) {}
    ...
    public async postFormAsync(uri: string, formData: FormData, headers?: Record<string, string>): Promise<APIResponse> {
